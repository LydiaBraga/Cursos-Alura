                ...
                _createClass(NegociacaoDao, [{
                    ...
                    value: function adiciona(negociacao) {
                        ...
                        return new Promise(function (resolve, reject) {
                            var requestStore = _this._connection.transaction([_this._store], "readwrite").objectStore(_this._store).add(negociacao);
                    ...
                    value: function apagaTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            var requestStore = _this3._connection.transaction([_this3._store], "readwrite").objectStore(_this3._store).clear();
